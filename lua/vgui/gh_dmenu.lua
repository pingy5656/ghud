...
function PANEL:AddOption( strText, funcFunction )
	...
	local pnl = vgui.Create( "GH_DMenuOption", self )
	pnl:SetMenu( self )
	pnl:SetText( strText )
...
function PANEL:Paint( w, h )
	...
	draw.RoundedBox( 0, 0, 0, w, h, glorioushud.settings.vguiclrs.cornerclr )
...
derma.DefineControl( "GH_DMenu", "A Menu", PANEL, "DScrollPanel" )
