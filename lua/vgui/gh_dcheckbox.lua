...
local on, off = Material( 'icons/vgui/check-square.png' ), Material( 'icons/vgui/square.png' )
...
function PANEL:Paint( w, h )
	...
	draw.RoundedBox( 5, 0, 0, 24, 24, ColorAlpha( glorioushud.settings.vguiclrs.checkboxhover, self.alpha ) )
...
derma.DefineControl( "GH_DCheckBox", "Simple Checkbox", PANEL, "DButton" )
...
derma.DefineControl( "GH_DCheckBoxLabel", "Simple Checkbox", PANEL, "DPanel" )
