...
local circle = Material( 'icons/vgui/circle15.png' )
...
function PANEL:Init()
	...
	self.Knob.color = glorioushud.settings.vguiclrs.sliderpoint
	self.Knob:SetText( '' )
	self.Knob:SetSize( 15, 15 )
	self.Knob:NoClipping( true )
	self.Knob.OnCursorEntered = function()
		self.Knob.color = glorioushud.settings.vguiclrs.sliderhover
	end
	...
	self.Knob.Paint = function( panel, w, h ) 
		...
		surface.SetDrawColor( self.Knob.color )
		surface.SetMaterial( circle )
		surface.DrawTexturedRect( -1, 15 / 2 / 2 - 1, 15, 15 )
...
derma.DefineControl( "GH_DSlider", "", PANEL, "Panel" )
