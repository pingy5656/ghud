...
function PANEL:Init()
	...
	self:SetTextColor( glorioushud.settings.vguiclrs.textclr )
	self:SetFontInternal( 'glorioushud.font.pickup15' )

	self.corner = Color( 50, 50, 50, 255 )
...
function PANEL:OpenMenu( pControlOpener )
	...
	self.Menu = vgui.Create( 'GH_DMenu', self )
	...
	self.Menu:Open( x, y + 5, false, self )
...
function PANEL:OnCursorEntered()
	...
	self.corner = glorioushud.settings.vguiclrs.hoverclr
	self.hover = true
...
function PANEL:OnCursorExited()
	...
	self.corner = !self:IsMenuOpen() and glorioushud.settings.vguiclrs.backgroundclr or glorioushud.settings.vguiclrs.cornerclr
	self.hover = false
...
function PANEL:Paint( w, h )
	...
	if( !self:IsMenuOpen() && !self.hover ) then
		self.corner = glorioushud.settings.vguiclrs.backgroundclr
	end
	draw.RoundedBox( 0, 0, 0, w, h, self.corner )
	draw.RoundedBox( 0, 2, 2, w - 4, h - 4, glorioushud.settings.vguiclrs.backgroundclr )
...
derma.DefineControl( "GH_DComboBox", "", PANEL, "DButton" )
