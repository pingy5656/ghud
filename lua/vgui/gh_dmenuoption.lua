...
function PANEL:AddSubMenu()
	...
	local SubMenu = vgui.Create( 'GH_DMenu', self )
...
function PANEL:Paint( w, h )
	...
	draw.RoundedBox( 0, 2, 2, w - 4, h - 4, ColorAlpha( glorioushud.settings.vguiclrs.dmenuhover, self.alpha ) )
...
derma.DefineControl( "GH_DMenuOption", "Menu Option Line", PANEL, "DButton" )
